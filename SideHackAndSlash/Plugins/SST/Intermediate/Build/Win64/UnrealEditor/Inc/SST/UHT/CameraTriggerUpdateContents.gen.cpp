...
template<> SST_API UScriptStruct* StaticStruct<FCameraTriggerUpdateVector>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Milan_Documents_GitHub_2DHackAndSlash_SideHackAndSlash_Plugins_SST_Source_SST_Public_CameraTriggerUpdateContents_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Milan_Documents_GitHub_2DHackAndSlash_SideHackAndSlash_Plugins_SST_Source_SST_Public_CameraTriggerUpdateContents_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Milan_Documents_GitHub_2DHackAndSlash_SideHackAndSlash_Plugins_SST_Source_SST_Public_CameraTriggerUpdateContents_h_Statics::ScriptStructInfo[] = {
		{ FCameraTriggerUpdateFloat::StaticStruct, Z_Construct_UScriptStruct_FCameraTriggerUpdateFloat_Statics::NewStructOps, TEXT("CameraTriggerUpdateFloat"), &Z_Registration_Info_UScriptStruct_CameraTriggerUpdateFloat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraTriggerUpdateFloat), 639974946U) },
		{ FCameraTriggerUpdateBool::StaticStruct, Z_Construct_UScriptStruct_FCameraTriggerUpdateBool_Statics::NewStructOps, TEXT("CameraTriggerUpdateBool"), &Z_Registration_Info_UScriptStruct_CameraTriggerUpdateBool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraTriggerUpdateBool), 3240792891U) },
		{ FCameraTriggerUpdateVector::StaticStruct, Z_Construct_UScriptStruct_FCameraTriggerUpdateVector_Statics::NewStructOps, TEXT("CameraTriggerUpdateVector"), &Z_Registration_Info_UScriptStruct_CameraTriggerUpdateVector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraTriggerUpdateVector), 1234460974U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Milan_Documents_GitHub_2DHackAndSlash_SideHackAndSlash_Plugins_SST_Source_SST_Public_CameraTriggerUpdateContents_h_2232653055(TEXT("/Script/SST"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_Milan_Documents_GitHub_2DHackAndSlash_SideHackAndSlash_Plugins_SST_Source_SST_Public_CameraTriggerUpdateContents_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Milan_Documents_GitHub_2DHackAndSlash_SideHackAndSlash_Plugins_SST_Source_SST_Public_CameraTriggerUpdateContents_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Users_Milan_Documents_GitHub_2DHackAndSlash_SideHackAndSlash_Plugins_SST_Source_SST_Public_CameraTriggerUpdateContents_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Milan_Documents_GitHub_2DHackAndSlash_SideHackAndSlash_Plugins_SST_Source_SST_Public_CameraTriggerUpdateContents_h_Statics::EnumInfo));
